...
public class SwipeListView extends ListView {
     ...
     */
    public SwipeListView(Context context, int swipeBackView, int swipeFrontView, int maxMoveDis) {
        super(context);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            maxMoveDis = styled.getDimension(R.styleable.SwipeListView_maxMoveDis, 0);
        }
        ...
        touchListener = new SwipeListViewTouchListener(this, swipeFrontView, swipeBackView, maxMoveDis);
