...
import com.manager.adapter.HorizontalScrollViewAdapter;
...
//			mContainer = (LinearLayout) getChildAt(0);
    ...
    public void initDatas(HorizontalScrollViewAdapter mAdapter)
    {
        ...
        if (mChildWidth == 0 && mChildHeight == 0)
        {
            ...
            mChildHeight = view.getMeasuredHeight();
            // 计算每次加载多少个View
            mCountOneScreen = mAdapter.getCount();//(mScreenWitdh / mChildWidth == 0)?mScreenWitdh / mChildWidth+1:mScreenWitdh / mChildWidth+2;
    ...
    public Object getItem(int positon){
        return mAdapter.getItem(positon);
    }
