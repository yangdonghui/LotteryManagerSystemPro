...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.refresh_listview_header, this, false);

		mHeaderImageView = (ImageView) mHeaderView.findViewById(R.id.iv_listview_header_arrow);
		mHeaderTextView = (TextView) mHeaderView.findViewById(R.id.tv_listview_header_state);
		//mHeaderUpdateTextView = (TextView) mHeaderView.findViewById(R.id.pull_to_refresh_updated_at);
		mHeaderProgressBar = (ProgressBar) mHeaderView.findViewById(R.id.refresh_header_progress);
		// header layout
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.refresh_listview_footer, this, false);
		...
		mFooterProgressBar = (ProgressBar) mFooterView
				.findViewById(R.id.refresh_footer_progress);
		// footer layout
