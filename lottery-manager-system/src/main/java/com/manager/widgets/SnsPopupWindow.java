...
public class SnsPopupWindow extends PopupWindow implements OnClickListener{
	...
	public SnsPopupWindow(Context context) {
		...
		chatBtn = (TextView) view.findViewById(R.id.chatBtn);
		digImgv = (ImageView) view.findViewById(R.id.digicon);
		...
		this.setWidth(Tools.dip2px(context, 190));
		this.setHeight(Tools.dip2px(context, 30));
	...
	public void update() {
		...
		/*if (mActionItems != null && mActionItems.size() > 0){
			digImgv.setImageDrawable(mActionItems.get(0).mDrawable);
		}*/
	}
