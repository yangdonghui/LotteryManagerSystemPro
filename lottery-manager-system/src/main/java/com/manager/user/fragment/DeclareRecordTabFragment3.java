 ...
 */
public class DeclareRecordTabFragment3 extends Fragment {
    ...
    //静态对象
    private static DeclareRecordTabFragment3 mDeclareTabFragment = null;

    /**
     * 静态工厂方法需要一个int型的值来初始化fragment的参数，
     * 然后返回新的fragment到调用者
     */
    public static DeclareRecordTabFragment3 newInstance() {
        if (mDeclareTabFragment == null) {
            mDeclareTabFragment = new DeclareRecordTabFragment3();
        }
    ...
    private void InitData() {
        ...
        for(int i=0;i< Constants.DeclareLists.size();i++)
        {
            ...
            if (att.getDeclareState().equals("已完成")) {
                HashMap<String, Object> map = new HashMap<String, Object>();
                map.put("ItemNumber", String.valueOf(att.getID()));
                /*map.put("ItemMainType", att.getDeclareParentType());*/
