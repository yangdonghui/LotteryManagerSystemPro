...
import com.manager.community.spannable.CircleMovementMethod;
import com.manager.community.spannable.SpannableClickable;
...
public class PraiseListView extends TextView{
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(SysApplication.getAppContext(), R.mipmap.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
