package com.manager.community.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = SysApplication.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = SysApplication.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
    ...
    public boolean onTouchEvent(TextView widget, Spannable buffer,
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            widget.setBackgroundDrawable(null);
            //widget.setBackgroundColor(R.color.transparent);
