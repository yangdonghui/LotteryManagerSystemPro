 ...
 */
public class ManagerOrderChildListViewAdapter extends BaseAdapter {

    private Context context;                     //运行上下文
    private List<DeclareConsumableBean> listItems;    //商品信息集合
    ...
    public ManagerOrderChildListViewAdapter(Context context, List<DeclareConsumableBean> listItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        listItemView.title.setText(listItems.get(position).getDeclareChildType());
        listItemView.num.setText(context.getString(R.string.x_str) + String.valueOf(listItems.get(position).getNum()));
