...
/**
 * 管理员 耗材 订单管理等 list视图适配器
 * Created by Administrator on 2016/2/22 0022.
 */
public class ManagerConsumableOrdersListViewAdapter extends BaseAdapter{
    ...
    public ManagerConsumableOrdersListViewAdapter(Context context, List<DeclareOrdersBean> listItem, int tabIndex) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //数据列表
        ManagerOrderChildListViewAdapter myAdapter = new ManagerOrderChildListViewAdapter(context, listItems.get(position).getListConsumableData());
