 ...
 */
public class BillingRecordTabFragment2 extends Fragment {
    ...
    //静态对象
    private static BillingRecordTabFragment2 mTabFragment = null;

    /**
     * 静态工厂方法需要一个int型的值来初始化fragment的参数，
     * 然后返回新的fragment到调用者
     */
    public static BillingRecordTabFragment2 newInstance() {
        if (mTabFragment == null) {
            mTabFragment = new BillingRecordTabFragment2();
        }
