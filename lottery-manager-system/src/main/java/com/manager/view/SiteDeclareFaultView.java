 ...
 */
public class SiteDeclareFaultView extends LinearLayout implements View.OnClickListener{
    ...
    public SiteDeclareFaultView(Context context) {
        super(context);
    ...
    public SiteDeclareFaultView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView() {
        mView = LayoutInflater.from(mContext).inflate(R.layout.site_declare_fault_layout, this, true);
        childTypeView = (TextView) mView.findViewById(R.id.site_declare_child_type_fault);
