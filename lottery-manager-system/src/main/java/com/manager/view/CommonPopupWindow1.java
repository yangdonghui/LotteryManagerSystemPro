 ...
 */
public class CommonPopupWindow1 extends PopupWindow implements View.OnClickListener, OnWheelChangedListener {
    ...
    public CommonPopupWindow1(Activity context, String[] datas, int curIndex) {
        super(context);
        ...
        mMenuView = inflater.inflate(R.layout.common_menu_layout1, null);
    ...
    private void setUpViews() {
        mWheelView = (WheelView) mMenuView.findViewById(R.id.common_menu1_wheelview);

        mBtnConfirm = (TextView) mMenuView.findViewById(R.id.common_menu1_btn_confirm);
        mBtnCancel = (TextView) mMenuView.findViewById(R.id.common_menu1_btn_cancel);
